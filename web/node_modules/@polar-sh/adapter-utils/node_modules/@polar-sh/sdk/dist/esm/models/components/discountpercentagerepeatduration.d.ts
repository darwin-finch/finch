...
export type DiscountPercentageRepeatDurationMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountPercentageRepeatDurationMetadata$Outbound = string | number | number | boolean;
/** @internal */
