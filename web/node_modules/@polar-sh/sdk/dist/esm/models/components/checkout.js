...
/** @internal */
export const CheckoutMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/** @internal */
export const CheckoutMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
/** @internal */
export const CheckoutCustomerMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/** @internal */
export const CheckoutCustomerMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CheckoutCustomerMetadata$;
(function (CheckoutCustomerMetadata$) {
    /** @deprecated use `CheckoutCustomerMetadata$inboundSchema` instead. */
    CheckoutCustomerMetadata$.inboundSchema = CheckoutCustomerMetadata$inboundSchema;
    /** @deprecated use `CheckoutCustomerMetadata$outboundSchema` instead. */
    CheckoutCustomerMetadata$.outboundSchema = CheckoutCustomerMetadata$outboundSchema;
})(CheckoutCustomerMetadata$ || (CheckoutCustomerMetadata$ = {}));
export function checkoutCustomerMetadataToJSON(checkoutCustomerMetadata) {
    return JSON.stringify(CheckoutCustomerMetadata$outboundSchema.parse(checkoutCustomerMetadata));
}
export function checkoutCustomerMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CheckoutCustomerMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CheckoutCustomerMetadata' from JSON`);
}
/** @internal */
