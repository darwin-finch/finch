...
/** @internal */
export const BenefitGitHubRepositoryPropertiesPermission$inboundSchema = z
    .nativeEnum(BenefitGitHubRepositoryPropertiesPermission);
/** @internal */
export const BenefitGitHubRepositoryPropertiesPermission$outboundSchema = BenefitGitHubRepositoryPropertiesPermission$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BenefitGitHubRepositoryPropertiesPermission$;
(function (BenefitGitHubRepositoryPropertiesPermission$) {
    ...
    BenefitGitHubRepositoryPropertiesPermission$.inboundSchema = BenefitGitHubRepositoryPropertiesPermission$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositoryPropertiesPermission$outboundSchema` instead. */
    BenefitGitHubRepositoryPropertiesPermission$.outboundSchema = BenefitGitHubRepositoryPropertiesPermission$outboundSchema;
})(BenefitGitHubRepositoryPropertiesPermission$ || (BenefitGitHubRepositoryPropertiesPermission$ = {}));
/** @internal */
