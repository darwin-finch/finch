 ...
 */
export declare const BenefitGitHubRepositoryPropertiesPermission: {
    readonly Pull: "pull";
 ...
 * The permission level to grant. Read more about roles and their permissions on [GitHub documentation](https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-repository-roles/repository-roles-for-an-organization#permissions-for-each-role).
 */
export type BenefitGitHubRepositoryPropertiesPermission = ClosedEnum<typeof BenefitGitHubRepositoryPropertiesPermission>;
/**
...
/** @internal */
export declare const BenefitGitHubRepositoryPropertiesPermission$inboundSchema: z.ZodNativeEnum<typeof BenefitGitHubRepositoryPropertiesPermission>;
/** @internal */
export declare const BenefitGitHubRepositoryPropertiesPermission$outboundSchema: z.ZodNativeEnum<typeof BenefitGitHubRepositoryPropertiesPermission>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace BenefitGitHubRepositoryPropertiesPermission$ {
