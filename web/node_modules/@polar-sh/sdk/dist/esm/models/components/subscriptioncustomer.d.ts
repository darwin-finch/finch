...
/** @internal */
export declare const SubscriptionCustomerTaxId$inboundSchema: z.ZodType<SubscriptionCustomerTaxId, z.ZodTypeDef, unknown>;
/** @internal */
export type SubscriptionCustomerTaxId$Outbound = string | string;
/** @internal */
export declare const SubscriptionCustomerTaxId$outboundSchema: z.ZodType<SubscriptionCustomerTaxId$Outbound, z.ZodTypeDef, SubscriptionCustomerTaxId>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace SubscriptionCustomerTaxId$ {
    ...
    type Outbound = SubscriptionCustomerTaxId$Outbound;
}
export declare function subscriptionCustomerTaxIdToJSON(subscriptionCustomerTaxId: SubscriptionCustomerTaxId): string;
export declare function subscriptionCustomerTaxIdFromJSON(jsonString: string): SafeParseResult<SubscriptionCustomerTaxId, SDKValidationError>;
/** @internal */
