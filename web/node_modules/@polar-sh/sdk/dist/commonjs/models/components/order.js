...
exports.Order$ = exports.Order$outboundSchema = exports.Order$inboundSchema = exports.OrderDiscount$ = exports.OrderDiscount$outboundSchema = exports.OrderDiscount$inboundSchema = exports.OrderProductPrice$ = exports.OrderProductPrice$outboundSchema = exports.OrderProductPrice$inboundSchema = exports.OrderCustomFieldData$ = exports.OrderCustomFieldData$outboundSchema = exports.OrderCustomFieldData$inboundSchema = exports.OrderMetadata$ = exports.OrderMetadata$outboundSchema = exports.OrderMetadata$inboundSchema = void 0;
...
exports.orderProductPriceToJSON = orderProductPriceToJSON;
exports.orderProductPriceFromJSON = orderProductPriceFromJSON;
...
(function (OrderProductPrice$) {
    /** @deprecated use `OrderProductPrice$inboundSchema` instead. */
    OrderProductPrice$.inboundSchema = exports.OrderProductPrice$inboundSchema;
    /** @deprecated use `OrderProductPrice$outboundSchema` instead. */
    OrderProductPrice$.outboundSchema = exports.OrderProductPrice$outboundSchema;
})(OrderProductPrice$ || (exports.OrderProductPrice$ = OrderProductPrice$ = {}));
function orderProductPriceToJSON(orderProductPrice) {
    return JSON.stringify(exports.OrderProductPrice$outboundSchema.parse(orderProductPrice));
}
function orderProductPriceFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.OrderProductPrice$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OrderProductPrice' from JSON`);
}
/** @internal */
