...
/** @internal */
export declare const CheckoutCustomerMetadata$inboundSchema: z.ZodType<CheckoutCustomerMetadata, z.ZodTypeDef, unknown>;
/** @internal */
export type CheckoutCustomerMetadata$Outbound = string | number | boolean;
/** @internal */
export declare const CheckoutCustomerMetadata$outboundSchema: z.ZodType<CheckoutCustomerMetadata$Outbound, z.ZodTypeDef, CheckoutCustomerMetadata>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CheckoutCustomerMetadata$ {
    /** @deprecated use `CheckoutCustomerMetadata$inboundSchema` instead. */
    const inboundSchema: z.ZodType<CheckoutCustomerMetadata, z.ZodTypeDef, unknown>;
    /** @deprecated use `CheckoutCustomerMetadata$outboundSchema` instead. */
    const outboundSchema: z.ZodType<CheckoutCustomerMetadata$Outbound, z.ZodTypeDef, CheckoutCustomerMetadata>;
    /** @deprecated use `CheckoutCustomerMetadata$Outbound` instead. */
    type Outbound = CheckoutCustomerMetadata$Outbound;
}
export declare function checkoutCustomerMetadataToJSON(checkoutCustomerMetadata: CheckoutCustomerMetadata): string;
export declare function checkoutCustomerMetadataFromJSON(jsonString: string): SafeParseResult<CheckoutCustomerMetadata, SDKValidationError>;
/** @internal */
