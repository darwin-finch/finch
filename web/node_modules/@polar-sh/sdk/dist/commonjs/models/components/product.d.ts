...
/** @internal */
export declare const ProductPrices$inboundSchema: z.ZodType<ProductPrices, z.ZodTypeDef, unknown>;
/** @internal */
export type ProductPrices$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const ProductPrices$outboundSchema: z.ZodType<ProductPrices$Outbound, z.ZodTypeDef, ProductPrices>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ProductPrices$ {
    /** @deprecated use `ProductPrices$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ProductPrices, z.ZodTypeDef, unknown>;
    /** @deprecated use `ProductPrices$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ProductPrices$Outbound, z.ZodTypeDef, ProductPrices>;
    /** @deprecated use `ProductPrices$Outbound` instead. */
    type Outbound = ProductPrices$Outbound;
}
export declare function productPricesToJSON(productPrices: ProductPrices): string;
export declare function productPricesFromJSON(jsonString: string): SafeParseResult<ProductPrices, SDKValidationError>;
/** @internal */
