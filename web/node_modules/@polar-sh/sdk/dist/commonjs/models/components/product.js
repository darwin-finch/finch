...
exports.Product$ = exports.Product$outboundSchema = exports.Product$inboundSchema = exports.ProductPrices$ = exports.ProductPrices$outboundSchema = exports.ProductPrices$inboundSchema = exports.ProductMetadata$ = exports.ProductMetadata$outboundSchema = exports.ProductMetadata$inboundSchema = void 0;
exports.productMetadataToJSON = productMetadataToJSON;
exports.productMetadataFromJSON = productMetadataFromJSON;
exports.productPricesToJSON = productPricesToJSON;
exports.productPricesFromJSON = productPricesFromJSON;
...
/** @internal */
exports.ProductMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/** @internal */
exports.ProductMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.boolean()]);
/**
 * @internal
...
(function (ProductPrices$) {
    ...
    ProductPrices$.inboundSchema = exports.ProductPrices$inboundSchema;
    /** @deprecated use `ProductPrices$outboundSchema` instead. */
    ProductPrices$.outboundSchema = exports.ProductPrices$outboundSchema;
})(ProductPrices$ || (exports.ProductPrices$ = ProductPrices$ = {}));
function productPricesToJSON(productPrices) {
    return JSON.stringify(exports.ProductPrices$outboundSchema.parse(productPrices));
}
function productPricesFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProductPrices$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProductPrices' from JSON`);
}
/** @internal */
