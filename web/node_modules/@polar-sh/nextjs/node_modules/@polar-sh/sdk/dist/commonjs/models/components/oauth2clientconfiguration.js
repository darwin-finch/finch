...
exports.OAuth2ClientConfiguration$ = exports.OAuth2ClientConfiguration$outboundSchema = exports.OAuth2ClientConfiguration$inboundSchema = exports.GrantTypes$ = exports.GrantTypes$outboundSchema = exports.GrantTypes$inboundSchema = exports.TokenEndpointAuthMethod$ = exports.TokenEndpointAuthMethod$outboundSchema = exports.TokenEndpointAuthMethod$inboundSchema = exports.GrantTypes = exports.TokenEndpointAuthMethod = void 0;
exports.oAuth2ClientConfigurationToJSON = oAuth2ClientConfigurationToJSON;
exports.oAuth2ClientConfigurationFromJSON = oAuth2ClientConfigurationFromJSON;
...
/** @internal */
exports.OAuth2ClientConfiguration$inboundSchema = z.object({
    ...
    default_sub_type: subtype_js_1.SubType$inboundSchema.optional(),
}).transform((v) => {
...
/** @internal */
exports.OAuth2ClientConfiguration$outboundSchema = z.object({
    ...
    defaultSubType: subtype_js_1.SubType$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var OAuth2ClientConfiguration$;
(function (OAuth2ClientConfiguration$) {
    /** @deprecated use `OAuth2ClientConfiguration$inboundSchema` instead. */
    OAuth2ClientConfiguration$.inboundSchema = exports.OAuth2ClientConfiguration$inboundSchema;
    /** @deprecated use `OAuth2ClientConfiguration$outboundSchema` instead. */
    OAuth2ClientConfiguration$.outboundSchema = exports.OAuth2ClientConfiguration$outboundSchema;
})(OAuth2ClientConfiguration$ || (exports.OAuth2ClientConfiguration$ = OAuth2ClientConfiguration$ = {}));
function oAuth2ClientConfigurationToJSON(oAuth2ClientConfiguration) {
    return JSON.stringify(exports.OAuth2ClientConfiguration$outboundSchema.parse(oAuth2ClientConfiguration));
}
function oAuth2ClientConfigurationFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.OAuth2ClientConfiguration$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'OAuth2ClientConfiguration' from JSON`);
}
