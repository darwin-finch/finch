...
export const OrganizationCreate$inboundSchema = z.object({
    ...
    notification_settings: z.nullable(OrganizationNotificationSettings$inboundSchema).optional(),
    customer_email_settings: z.nullable(OrganizationCustomerEmailSettings$inboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
...
export const OrganizationCreate$outboundSchema = z.object({
    ...
    notificationSettings: z.nullable(OrganizationNotificationSettings$outboundSchema).optional(),
    customerEmailSettings: z.nullable(OrganizationCustomerEmailSettings$outboundSchema).optional(),
}).transform((v) => {
    return remap$(v, {
