...
export type DiscountPercentageOnceForeverDurationBaseMetadata = string | number | number | boolean;
...
/** @internal */
export type DiscountPercentageOnceForeverDurationBaseMetadata$Outbound = string | number | number | boolean;
/** @internal */
