...
export type DiscountPercentageOnceForeverDurationMetadata = string | number | number | boolean;
/**
...
/** @internal */
export type DiscountPercentageOnceForeverDurationMetadata$Outbound = string | number | number | boolean;
/** @internal */
