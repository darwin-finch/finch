...
export type DiscountPercentageRepeatDurationBaseMetadata = string | number | number | boolean;
...
/** @internal */
export type DiscountPercentageRepeatDurationBaseMetadata$Outbound = string | number | number | boolean;
/** @internal */
