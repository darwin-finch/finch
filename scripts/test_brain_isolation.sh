...
assert_inventory 'supervised script inventory' \
...
assert_inventory 'integration entrypoint inventory' \
...
assert_inventory 'escape-API allowlist' "$escape_uses" "$expected_escape_uses"
