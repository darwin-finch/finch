...
event-loop trampoline and resumes at the next instruction when scheduled again. It may occur more
than once in one program; it is not an LLM-authored continuation value. Future `fiber<yield,return>`
