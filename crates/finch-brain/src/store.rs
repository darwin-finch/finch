...
struct BrainState {
    ...
    effect_audits: finch_runtime::EffectAuditReducer,
...
#[cfg(any(test, feature = "test-support"))]
pub fn seed_scheduled_brain_for_tests(
    store: &BrainStore,
    name: &str,
    next_due_ms: u64,
...
impl BrainState {
    fn from_events(brain_id: BrainId, events: Vec<BrainEvent>) -> Self {
        ...
        let mut state = Self {
            ...
            effect_audits: finch_runtime::EffectAuditReducer::default(),
    ...
    fn apply(&mut self, event: BrainEvent) {
        ...
        match &event.kind {
            ...
            BrainEventKind::EffectRecorded {
                ...
                let identity = finch_runtime::EffectAuditIdentity {
                ...
                let authority = finch_runtime::EffectAuditAuthority {
                ...
                self.effect_audits
                    .apply(finch_runtime::EffectAuditTransition::Reserve {
                        intent: finch_runtime::EffectAuditIntent::from_effect(identity, effect)
                            .expect("legacy effect audit payload must be bounded"),
                        authority: authority.clone(),
                    })
                    .expect("legacy effect reservation must project");
                self.effect_audits
                    .apply(finch_runtime::EffectAuditTransition::Finish {
                        identity,
                        authority_id: authority.authority_id,
                        outcome: finch_runtime::EffectAuditTerminalOutcome::LegacyV14Snapshot {
                            state: state.clone(),
                        },
                    })
...
pub struct EffectAuditAuthorityGrant {
    brain: String,
    run_id: RunId,
    authority: finch_runtime::EffectAuditAuthority,
}
...
pub struct BrainStore {
    ...
    runtimes: Arc<RwLock<HashMap<String, Arc<finch_runtime::ProgramRuntime>>>>,
    runtime_checkpoints: Arc<RwLock<HashMap<String, finch_vm::TypedRuntimeCheckpoint>>>,
    /// Brain-bound portable effect delivery logs. Distinct from the typed
    /// continuation journal and from write-ahead effect audit.
    delivery_logs:
        Arc<RwLock<HashMap<String, Arc<std::sync::Mutex<finch_runtime::VmEffectDeliveryLog>>>>>,
...
impl BrainStore {
    ...
    pub fn schedule_disconnect_terminalization_retry(
        &self,
        name: String,
        sender: String,
        run_id: RunId,
    ...
    pub fn schedule_reserved_cancellation_retry(
        &self,
        name: String,
        sender: String,
        run_id: RunId,
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn with_test_environment_generation(
        machine: impl Into<String>,
        root: Option<PathBuf>,
        generation: u64,
    ) -> Self {
    ...
    pub fn retire_connection_and_owned_active_runs(
        &self,
        name: &str,
        attachment_id: AttachmentId,
        connection_id: ConnectionId,
    ...
    pub async fn acquire_run_publication(
        &self,
        name: &str,
        run_id: RunId,
    ...
    pub async fn reserve_run_publication_cancellation(
        &self,
        name: &str,
        run_id: RunId,
    ) -> Result<()> {
    ...
    pub fn snapshot(&self, name: &str) -> Result<BrainSnapshot> {
        ...
        Ok(BrainSnapshot {
            ...
            effect_audits: state
                ...
                .entries()
                .values()
                .map(finch_runtime::EffectAuditEntry::observer_projection)
    ...
    pub fn issue_effect_audit_authority(
        &self,
        name: &str,
        run_id: RunId,
    ...
    pub fn reconcile_effect_audits_for_disconnected_leases(
        &self,
        name: &str,
            ...
            .filter_map(|entry| {
                (lease_ids.contains(&entry.authority.runner_lease_id)
                    ...
                    .then(|| match &entry.state {
                        finch_runtime::EffectAuditState::IntentAccepted => Some((
                            entry.intent.identity,
                            entry.authority.authority_id,
                            finch_runtime::EffectAuditTerminalOutcome::AbandonedNotApplied,
                        )),
                        finch_runtime::EffectAuditState::AwaitingHostResult => Some((
                            entry.intent.identity,
                            entry.authority.authority_id,
                            finch_runtime::EffectAuditTerminalOutcome::UncertainProcessLoss,
                        )),
                        finch_runtime::EffectAuditState::Terminal { .. } => None,
                    })
                    .flatten()
            })
            .collect::<Vec<_>>();
        let transitions = unresolved
            .iter()
            .map(
                |(identity, authority_id, outcome)| finch_runtime::EffectAuditTransition::Finish {
                    identity: *identity,
    ...
    pub fn abandon_unbegun_effect_audits(
        &self,
        grant: &EffectAuditAuthorityGrant,
    ) -> Result<usize> {
    ...
    fn terminalize_effect_audit_authority(
            ...
            .filter_map(|entry| {
                (entry.intent.identity.run_id == grant.run_id.0
                    ...
                    .then(|| match &entry.state {
                        ...
                        finch_runtime::EffectAuditState::AwaitingHostResult if process_lost => {
                            Some((
                                entry.intent.identity,
                                finch_runtime::EffectAuditTerminalOutcome::UncertainProcessLoss,
                            ))
                        }
                        finch_runtime::EffectAuditState::AwaitingHostResult => None,
                        finch_runtime::EffectAuditState::Terminal { .. } => None,
                    })
                    .flatten()
            })
        ...
        let transitions = unresolved
            .iter()
            .map(
                |(identity, outcome)| finch_runtime::EffectAuditTransition::Finish {
                    identity: *identity,
    ...
    pub fn retry_effect_audit_reservation(
        &self,
        grant: &EffectAuditAuthorityGrant,
        execution_id: uuid::Uuid,
        effect: &finch_vm::VmSideEffect,
    ) -> Result<Option<finch_runtime::EffectAuditIdentity>> {
        let name = Self::validate_name(&grant.brain)?;
        self.ensure_loaded(name)?;
        let brains = self.brains.read().expect("shared brain lock poisoned");
        let state = brains.get(name).context("Brain was removed concurrently")?;
        ...
        let transition = finch_runtime::EffectAuditTransition::Reserve {
            intent: finch_runtime::EffectAuditIntent::from_effect(identity, effect)?,
        ...
        {
            let mut archived = finch_runtime::EffectAuditReducer::default();
    ...
    pub fn reserve_effect_audit(
        &self,
        grant: &EffectAuditAuthorityGrant,
        execution_id: uuid::Uuid,
        effect: finch_vm::VmSideEffect,
    ) -> Result<finch_runtime::EffectAuditIdentity> {
        let name = Self::validate_name(&grant.brain)?;
        self.ensure_loaded(name)?;
        let mut brains = self.brains.write().expect("shared brain lock poisoned");
        let state = brains
    ...
    pub fn begin_effect_audit(
        &self,
        grant: &EffectAuditAuthorityGrant,
        identity: finch_runtime::EffectAuditIdentity,
    ) -> Result<finch_runtime::HostEffectPermit> {
        let name = Self::validate_name(&grant.brain)?;
        self.ensure_loaded(name)?;
        let mut brains = self.brains.write().expect("shared brain lock poisoned");
        let state = brains
        ...
        anyhow::ensure!(
            state
                ...
                .is_some_and(|entry| matches!(
                    entry.state,
                    finch_runtime::EffectAuditState::IntentAccepted
                )),
        ...
        self.append_effect_audit_transition_locked(
            name,
            state,
            finch_runtime::EffectAuditTransition::Begin {
                identity,
                authority_id: grant.authority.authority_id,
            },
        )?;
        Ok(finch_runtime::HostEffectPermit::new(
            identity,
    ...
    pub fn finish_effect_audit(
        &self,
        grant: &EffectAuditAuthorityGrant,
        permit: Option<&finch_runtime::HostEffectPermit>,
        identity: finch_runtime::EffectAuditIdentity,
        outcome: finch_runtime::EffectAuditTerminalOutcome,
    ) -> Result<()> {
        let name = Self::validate_name(&grant.brain)?;
        self.ensure_loaded(name)?;
        anyhow::ensure!(
        ...
        if let Some(permit) = permit {
            ...
            anyhow::ensure!(
                matches!(
                    outcome,
                    finch_runtime::EffectAuditTerminalOutcome::NotApplied { .. }
                ),
        ...
        self.append_effect_audit_transition_locked(
            name,
            state,
            finch_runtime::EffectAuditTransition::Finish {
                identity,
                authority_id: grant.authority.authority_id,
                outcome,
            },
    ...
    fn append_effect_audit_transition_locked(
        ...
        transition: finch_runtime::EffectAuditTransition,
    ) -> Result<bool> {
        ...
        if self.root.is_some() {
            self.with_effect_audit_storage_mut(name, state.brain_id, |storage| {
                ...
                if matches!(
                    transition,
                    finch_runtime::EffectAuditTransition::Reserve { .. }
                ) {
    ...
    fn append_effect_audit_transition_batch_locked(
        ...
        name: &str,
        state: &mut BrainState,
        transitions: Vec<finch_runtime::EffectAuditTransition>,
    ) -> Result<usize> {
    ...
    fn archive_terminal_effect_audits_batch_locked(
        ...
        name: &str,
        state: &mut BrainState,
        terminal: &[(u64, finch_runtime::EffectAuditIdentity)],
    ) -> Result<()> {
        ...
        for (seq, identity) in terminal {
            ...
            fences.push((*seq, finch_runtime::replay_fence_transition(entry)?));
        }
        if fences.is_empty() {
            return Ok(());
        }
    ...
    fn compact_terminal_effect_audits_locked(
        ...
        for event in &state.events {
            ...
            match transition {
                finch_runtime::EffectAuditTransition::Reserve { .. } => {}
                finch_runtime::EffectAuditTransition::Begin { .. } => {}
                finch_runtime::EffectAuditTransition::Finish { identity, .. } => {
                    ...
                    compacted.kind = BrainEventKind::EffectAuditTransition {
                        transition: finch_runtime::replay_fence_transition(entry)?,
                    };
                    anyhow::ensure!(
                        serde_json::to_vec(&compacted)?.len()
                            <= finch_runtime::MAX_EFFECT_AUDIT_REPLAY_FENCE_EVENT_BYTES,
                        "effect audit replay fence event exceeds its fixed encoded bound"
                    );
                    retained_events.push(compacted);
                }
                finch_runtime::EffectAuditTransition::Fence { .. } => {
                    retained_events.push(event.clone())
                }
            }
        }
    ...
    pub fn terminalize_run_with_result_if_active(
        &self,
        name: &str,
        sender: &str,
        run_id: RunId,
    ...
    pub fn begin_run_approval_for_connection(
        &self,
        name: &str,
        attachment_id: AttachmentId,
        connection_id: ConnectionId,
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn pause_after_cancellation_reservation_for_test(
        &self,
    ...
    pub fn pending_reserved_cancellations_for_attachment(
        &self,
        name: &str,
        attachment_id: AttachmentId,
    ) -> Result<Vec<RunId>> {
    ...
    pub fn complete_reserved_run_cancellation_on_disconnect(
        &self,
        name: &str,
        sender: &str,
        run_id: RunId,
    ...
    pub fn program_runtime(&self, name: &str) -> Result<Arc<finch_runtime::ProgramRuntime>> {
        ...
        let mut runtime = match checkpoint {
            Some(checkpoint) => finch_runtime::ProgramRuntime::from_checkpoint_at_revision(
                self.read_runtime_checkpoint(name, &checkpoint.checkpoint_sha256)?,
                checkpoint.durable_revision,
            )?,
            None => finch_runtime::ProgramRuntime::new(),
        };
    ...
    fn bind_runtime_delivery_log(
        &self,
        name: &str,
        runtime: &finch_runtime::ProgramRuntime,
    ) -> Result<()> {
    ...
    pub fn effect_delivery_log(
        ...
        let log = Arc::new(std::sync::Mutex::new(
            finch_runtime::VmEffectDeliveryLog::open_bound(path, brain_id)?,
        ));
        let mut logs = self
            .delivery_logs
            .write()
    ...
    pub fn record_effect_delivery(
        &self,
        name: &str,
        envelopes: &[finch_runtime::VmEffectEnvelope],
    ) -> Result<()> {
    ...
    pub fn pending_effect_delivery(
        &self,
        name: &str,
        consumer: finch_runtime::DeliveryConsumerIdentity,
    ) -> Result<Vec<finch_runtime::VmEffectEnvelope>> {
        let Some(log) = self.effect_delivery_log(name)? else {
            return Ok(Vec::new());
        };
        let log = log
    ...
    pub fn pending_effect_delivery_frames(
        ...
        self.pending_effect_delivery(name, consumer)?
            .into_iter()
            .map(|envelope| {
                finch_runtime::encode_runtime_application_message_packed(
                    &finch_runtime::RuntimeApplicationMessage::Envelope { envelope },
                )
            })
            .collect()
    }
    ...
    pub fn acknowledge_effect_delivery(
        ...
        name: &str,
        consumer: finch_runtime::DeliveryConsumerIdentity,
        cursor: finch_runtime::DeliveryCursor,
    ) -> Result<bool> {
        let Some(log) = self.effect_delivery_log(name)? else {
            return Ok(false);
        };
    ...
    fn commit_runner_runtime_inner(
        ...
        let restored = Arc::new(finch_runtime::ProgramRuntime::from_checkpoint_at_revision(
            checkpoint.clone(),
            runtime_revision,
        )?);
    ...
    fn read_runtime_checkpoint(
    ...
    ) -> Result<finch_vm::TypedRuntimeCheckpoint> {
        ...
        let checkpoint = if native {
            finch_runtime::decode_checkpoint_bytes(&encoded)
    ...
    fn runtime_authority_store(
        &self,
        name: &str,
    ) -> Option<finch_runtime::ProgramRuntimeAuthorityStore> {
        self.root.as_ref().map(|root| {
            finch_runtime::ProgramRuntimeAuthorityStore::new(root.join(name).join("authority.json"))
        })
    }
    ...
    fn ensure_loaded(&self, name: &str) -> Result<()> {
        ...
        let mut validated_effect_audits = finch_runtime::EffectAuditReducer::default();
        for event in &events {
            ...
            match &event.kind {
                ...
                BrainEventKind::EffectRecorded {
                    ...
                    validated_effect_audits.apply(
                        finch_runtime::EffectAuditTransition::Reserve {
                            intent: finch_runtime::EffectAuditIntent::from_effect(
                                identity, effect,
                            )?,
                            authority: authority.clone(),
                        },
        ...
        if self.root.is_some() {
            ...
            for fence in recent {
                let mut observer = finch_runtime::EffectAuditReducer::default();
        ...
        let restart_transitions = unresolved_effects
            ...
            .filter_map(|entry| {
                let outcome = match entry.state {
                    ...
                    finch_runtime::EffectAuditState::AwaitingHostResult => {
                        finch_runtime::EffectAuditTerminalOutcome::UncertainProcessLoss
                    }
                    finch_runtime::EffectAuditState::Terminal { .. } => return None,
                };
                Some(finch_runtime::EffectAuditTransition::Finish {
    ...
    #[cfg(any(test, feature = "test-support"))]
    pub fn seed_mature_effect_audit_history_for_test(
        &self,
        name: &str,
        records: usize,
        epochs: usize,
