# attachment — public interface

Generated from [`crates/finch-brain/src/attachment/mod.rs`](mod.rs) by `scripts/generate_interfaces.py`; CI fails if it drifts. Edit the code, then regenerate.

- **Facade:** `crates/finch-brain/src/attachment/mod.rs`
