...
struct RemoteBrainRequest {
    kind: crate::ipc_codec::BrainRemoteCommandKind,
    mutation: Option<crate::ipc_codec::BrainRemoteMutation>,
    response: oneshot::Sender<std::result::Result<crate::ipc_codec::BrainRemoteReply, String>>,
}
...
impl RemoteBrainClient {
    ...
    pub async fn test_send_remote_command(
        &self,
        kind: crate::test_support::BrainRemoteCommandKind,
    ) -> Result<crate::test_support::BrainRemoteReply> {
    ...
    pub async fn prepare_push_mutation(
        ...
        self.prepare_mutation(&crate::ipc_codec::BrainRemoteCommandKind::Submit(
            kind.clone(),
        ))
        .await
    }
    ...
    pub async fn prepare_runner_handoff_mutation(
        ...
        self.prepare_mutation(
            &crate::ipc_codec::BrainRemoteCommandKind::RequestRunnerHandoff {
                target_subject: target_subject.to_string(),
                expected_lease_id,
                environment_generation,
                ttl_ms,
    ...
    pub async fn prepare_cancel_runner_handoff_mutation(
        ...
        self.prepare_mutation(
            &crate::ipc_codec::BrainRemoteCommandKind::CancelRunnerHandoff(handoff_id),
        )
        .await
    }
    ...
    pub async fn prepare_cancel_run_mutation(
        ...
        self.prepare_mutation(&crate::ipc_codec::BrainRemoteCommandKind::CancelRun(run_id))
            .await
    }
    ...
    pub async fn prepare_create_schedule_mutation(
        ...
        self.prepare_mutation(&crate::ipc_codec::BrainRemoteCommandKind::CreateSchedule {
            language,
    ...
    pub async fn prepare_cancel_schedule_mutation(
        ...
        self.prepare_mutation(&crate::ipc_codec::BrainRemoteCommandKind::CancelSchedule(
            schedule_id,
        ))
        .await
    }
    ...
    pub async fn prepare_schedule_initialization_mutation(
        ...
        self.prepare_mutation(
            &crate::ipc_codec::BrainRemoteCommandKind::ScheduleInitialization { next_due_ms },
        )
        .await
    }
    ...
    pub async fn watch(&self) -> Result<mpsc::UnboundedReceiver<BrainWireMessage>> {
        use crate::ipc_codec::{BrainRemoteCommand, BrainRemoteEnvelope, BrainRemoteReply};
            ...
            loop {
                tokio::select! {
                    ...
                    request = command_rx.recv() => {
                        ...
                        let encoded = match crate::ipc_codec::encode_brain_remote_envelope(&envelope) {
                            Ok(encoded) => encoded,
                            Err(error) => {
                    ...
                    incoming = socket.next() => {
                        ...
                        match message {
                            tokio_tungstenite::tungstenite::Message::Binary(bytes) => {
                                match crate::ipc_codec::decode_brain_remote_envelope(&bytes) {
    ...
    async fn send_remote_command(
        &self,
        kind: crate::ipc_codec::BrainRemoteCommandKind,
    ) -> Result<crate::ipc_codec::BrainRemoteReply> {
        let durable = !matches!(
            &kind,
            crate::ipc_codec::BrainRemoteCommandKind::Acknowledge(_)
                | crate::ipc_codec::BrainRemoteCommandKind::Detach
        );
    ...
    async fn prepare_mutation(
        ...
        Ok(BrainMutationHandle {
            ...
            command_sha256: crate::ipc_codec::brain_remote_command_fingerprint(kind)?,
        })
    }
            ...
            Some(handle) => {
                ...
                anyhow::ensure!(
                    handle.command_sha256
                        == crate::ipc_codec::brain_remote_command_fingerprint(&kind)?,
                    "Brain mutation handle was reused with a different command"
                );
                Some(crate::ipc_codec::BrainRemoteMutation {
...
mod tests {
    ...
    async fn invitation_pinned_wss_handles_fragmented_binary_ping_pong_and_close() {
        use crate::ipc_codec::BrainRemoteEnvelope;
        use crate::{BrainEvent, ConnectionId};
        ...
        let secret = [47; 32];
        let authority = super::super::credential::BrainCredentialAuthority::ephemeral(secret);
        let store = crate::BrainStore::with_root("fixture.local", None);
        ...
        let fixture = tokio::spawn(async move {
            ...
            socket
                .send(Message::Binary(
                    crate::ipc_codec::encode_brain_remote_envelope(&snapshot)
                        .unwrap()
                        .into(),
                ))
                .await
            ...
            let encoded = crate::ipc_codec::encode_brain_remote_envelope(&envelope).unwrap();
        ...
        *client.credential.lock().await = Some(RemoteBrainCredential {
            ...
            claims: crate::credential::BrainCredentialClaims {
                version: 1,
                credential_id: uuid::Uuid::new_v4(),
                issuer: "fixture.local".into(),
    ...
    async fn remote_binary_session_correlates_mutations_while_streaming_events() {
        use crate::ipc_codec::{BrainRemoteCommandKind, BrainRemoteEnvelope, BrainRemoteReply};
        use crate::{BrainEvent, ConnectionId};
        ...
        let fixture = tokio::spawn(async move {
            ...
            socket
                .send(Message::Binary(
                    crate::ipc_codec::encode_brain_remote_envelope(&projection)
                        .unwrap()
                        .into(),
                ))
                .await
            ...
            let BrainRemoteEnvelope::Command(submit) =
                crate::ipc_codec::decode_brain_remote_envelope(&submit).unwrap()
            else {
            ...
            socket
                .send(Message::Binary(
                    crate::ipc_codec::encode_brain_remote_envelope(&reply)
                        .unwrap()
                        .into(),
                ))
                .await
            ...
            let BrainRemoteEnvelope::Command(acknowledge) =
                crate::ipc_codec::decode_brain_remote_envelope(&acknowledge).unwrap()
            else {
            ...
            let BrainRemoteEnvelope::Command(request_handoff) =
                crate::ipc_codec::decode_brain_remote_envelope(&request_handoff).unwrap()
            else {
            ...
            let handoff = crate::BrainRunnerHandoff {
                handoff_id: crate::RunnerHandoffId(uuid::Uuid::new_v4()),
            ...
            let BrainRemoteEnvelope::Command(cancel_handoff) =
                crate::ipc_codec::decode_brain_remote_envelope(&cancel_handoff).unwrap()
            else {
            ...
            let BrainRemoteEnvelope::Command(detach) =
                crate::ipc_codec::decode_brain_remote_envelope(&detach).unwrap()
            else {
        ...
        *client.credential.lock().await = Some(RemoteBrainCredential {
        ...
        let submit_handle = BrainMutationHandle {
            ...
            expected_revision: 1,
            environment_generation: 1,
            command_sha256: crate::ipc_codec::brain_remote_command_fingerprint(
        ...
        let lease_id = crate::RunnerLeaseId(uuid::Uuid::new_v4());
        ...
        let handoff_handle = BrainMutationHandle {
            ...
            expected_revision: 1,
            environment_generation: 1,
            command_sha256: crate::ipc_codec::brain_remote_command_fingerprint(&handoff_kind)
                .unwrap(),
        };
        let handoff = client
        ...
        let cancel_handle = BrainMutationHandle {
            ...
            expected_revision: 1,
            environment_generation: 1,
            command_sha256: crate::ipc_codec::brain_remote_command_fingerprint(&cancel_kind)
                .unwrap(),
        };
        client
    ...
    async fn remote_mutation_retry_preserves_idempotency_key_across_reconnect() {
        use crate::ipc_codec::{BrainRemoteEnvelope, BrainRemoteReply};
        use crate::{BrainEvent, ConnectionId};
        use tokio_tungstenite::tungstenite::Message;
        ...
        let fixture = tokio::spawn(async move {
            ...
            for attempt in 0..2 {
                ...
                let BrainRemoteEnvelope::Command(command) =
                    crate::ipc_codec::decode_brain_remote_envelope(&bytes).unwrap()
                else {
        ...
        *client.credential.lock().await = Some(RemoteBrainCredential {
        ...
        let kind = crate::ipc_codec::BrainRemoteCommandKind::Submit(BrainEventKind::Prompt {
            text: "once".into(),
            attached_mentions: Vec::new(),
        });
        let handle = BrainMutationHandle {
            ...
            command_sha256: crate::ipc_codec::brain_remote_command_fingerprint(&kind).unwrap(),
        };
        assert!(client
