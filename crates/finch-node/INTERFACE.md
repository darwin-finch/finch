# finch-node — public interface

Generated from [`crates/finch-node/src/lib.rs`](src/lib.rs) by `scripts/generate_interfaces.py`; CI fails if it drifts. Edit the code, then regenerate.

- **Facade:** `crates/finch-node/src/lib.rs`
...
impl IsolatedNodeTestState {
    ...
    /// Load persisted work statistics from this isolated state directory.
    pub fn load_work_stats(&self) -> anyhow::Result<WorkStats>;
...
impl NodeTlsIdentity {
    ...
    pub fn from_signing_identity_with_validity(identity: &NodeSigningIdentity, hostname: &str, not_before: (i32, u8, u8), not_after: (i32, u8, u8)) -> Result<Self>;
