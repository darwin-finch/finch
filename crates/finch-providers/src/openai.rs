...
impl OpenAIProvider {
    ...
    /// unlike "tools"). Every model-specific optional feature stays `Unknown`
    /// until a live `/api/show` attestation for this exact model has been
    /// cached.
    fn ollama_model_capabilities(&self, endpoint: &str, model: &str) -> ModelCapabilities {
        ...
        capabilities.streaming = ModelFeature::static_metadata(
