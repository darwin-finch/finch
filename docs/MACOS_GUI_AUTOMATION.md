...
pane is the authoritative user-facing target. Finch also reports its executable
path and launcher as diagnostic hints, but cannot derive the underlying TCC
identity from those hints. Restarting Finch may be necessary after changing the
setting.
