...
registry wording is superseded by `TYPED_LISP_FORTH_CAPABILITY_JIT_PLAN.md`: both frontends resolve
the shared vocabulary and lower identical ownership/effect semantics into the common typed IR,
whose verified host operations bind to the capability registry.
