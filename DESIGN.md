...
| **`brain`** (4): durable named Brains, the HTTP server and runner, daemon lifecycle | `src/brain`, `server`, `daemon`, `client`, `agent`, `review`, `registry` (migration only), `graph` | Brain capsule [`src/brain/AGENTS.md`](src/brain/AGENTS.md), interface [`src/brain/INTERFACE.md`](src/brain/INTERFACE.md); nested persistence facades [`src/brain/journal/AGENTS.md`](src/brain/journal/AGENTS.md), [`src/brain/schedule/AGENTS.md`](src/brain/schedule/AGENTS.md), [`src/brain/run/AGENTS.md`](src/brain/run/AGENTS.md), [`src/brain/attachment/AGENTS.md`](src/brain/attachment/AGENTS.md), [`src/brain/projection/AGENTS.md`](src/brain/projection/AGENTS.md); Daemon capsule [`src/daemon/AGENTS.md`](src/daemon/AGENTS.md), interface [`src/daemon/INTERFACE.md`](src/daemon/INTERFACE.md); see the [Brain test inventory](tests/BRAIN_TEST_INVENTORY.md) |
| **`frontend`** (5): commands, the interactive REPL, rendering, setup | `src/cli`, `startup.rs`, `samples.rs` | Capsule [`src/cli/repl_event/AGENTS.md`](src/cli/repl_event/AGENTS.md) for the event loop; capsule [`src/cli/messages/AGENTS.md`](src/cli/messages/AGENTS.md) for typed messages and WorkUnit domain snapshots; capsule [`src/cli/components/AGENTS.md`](src/cli/components/AGENTS.md) for component-owned ViewModels and subwidgets ([design](docs/TUI_DESIGN.md)); capsule [`src/cli/tui/AGENTS.md`](src/cli/tui/AGENTS.md), interface [`src/cli/tui/INTERFACE.md`](src/cli/tui/INTERFACE.md); [TUI renderer](src/cli/tui/ARCHITECTURE.md), [atomic history](src/cli/repl_event/ATOMIC_HISTORY.md) |
