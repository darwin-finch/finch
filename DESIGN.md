...
| **`frontend`** (5): commands, the interactive REPL, rendering, setup | `src/cli`, `startup.rs`, `samples.rs` | Capsule [`src/cli/repl_event/AGENTS.md`](src/cli/repl_event/AGENTS.md) for the event loop; capsule [`src/cli/tui/AGENTS.md`](src/cli/tui/AGENTS.md), interface [`src/cli/tui/INTERFACE.md`](src/cli/tui/INTERFACE.md); [TUI renderer](src/cli/tui/ARCHITECTURE.md), [atomic history](src/cli/repl_event/ATOMIC_HISTORY.md) |
