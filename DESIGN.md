...
| **`models`** (2): local model loading, routing, training, feedback | `src/models`, `local`, `generators`, `training`, `feedback`, `router`, `logging` | Capsule [`src/models/AGENTS.md`](src/models/AGENTS.md), interface [`src/models/INTERFACE.md`](src/models/INTERFACE.md); generators capsule [`src/generators/AGENTS.md`](src/generators/AGENTS.md), interface [`src/generators/INTERFACE.md`](src/generators/INTERFACE.md); [Local model loader](src/models/unified_loader.rs), [ONNX loader](src/models/ONNX.md), [bootstrap loading](src/models/BOOTSTRAP.md), [deferred LoRA path](src/models/LORA.md), [router](src/router/ROUTING.md), [automatic-training status](docs/AUTOMATIC_TRAINING.md) |
| **`providers`** (3): provider graph and wire transports, OAuth, planning prompts | `src/providers`, `claude`, `oauth`, `llms`, `planning` | Providers capsule [`src/providers/AGENTS.md`](src/providers/AGENTS.md), interface [`src/providers/INTERFACE.md`](src/providers/INTERFACE.md); OAuth capsule [`src/oauth/AGENTS.md`](src/oauth/AGENTS.md), interface [`src/oauth/INTERFACE.md`](src/oauth/INTERFACE.md); planning capsule [`src/planning/AGENTS.md`](src/planning/AGENTS.md), interface [`src/planning/INTERFACE.md`](src/planning/INTERFACE.md); [Claude client](src/claude/CLIENT.md), [OAuth boundary](docs/OAUTH.md), [ChatGPT subscription transport](docs/CHATGPT_SUBSCRIPTION_TRANSPORT.md), [OpenAI transport](docs/OPENAI_TRANSPORT.md) |
...
| **`frontend`** (5): commands, the interactive REPL, rendering, setup | `src/cli`, `startup.rs`, `samples.rs` | Capsule [`src/cli/repl_event/AGENTS.md`](src/cli/repl_event/AGENTS.md) for the event loop; [TUI renderer](src/cli/tui/ARCHITECTURE.md), [atomic history](src/cli/repl_event/ATOMIC_HISTORY.md) |
