...
| **`colisp`** (0): CoLisp reader and translation into the shared semantic-construction protocol | `crates/finch-colisp`; `vocabulary/language/FINCH_LISP.md` | Capsule [`crates/finch-colisp/AGENTS.md`](crates/finch-colisp/AGENTS.md), interface [`crates/finch-colisp/INTERFACE.md`](crates/finch-colisp/INTERFACE.md) |
...
| **`transport`** (3): domain-neutral Cap'n Proto schema/protocol/socket core, node identity, service discovery | `crates/finch-ipc`, `crates/finch-node`, `network`, `service` | IPC capsule [`crates/finch-ipc/AGENTS.md`](crates/finch-ipc/AGENTS.md), interface [`crates/finch-ipc/INTERFACE.md`](crates/finch-ipc/INTERFACE.md); application client adapter in `src/client`, daemon RPC adapter in `src/server`, Brain codec in `src/brain/ipc_codec.rs`, runtime checkpoint codec in `crates/finch-runtime/src/ipc_codec.rs`; Node capsule [`crates/finch-node/AGENTS.md`](crates/finch-node/AGENTS.md), interface [`crates/finch-node/INTERFACE.md`](crates/finch-node/INTERFACE.md), root compatibility facade [`src/node/AGENTS.md`](src/node/AGENTS.md); wire schema in [`crates/finch-ipc/schema/finch_ipc.capnp`](crates/finch-ipc/schema/finch_ipc.capnp) |
| **`brain`** (4): durable named Brains, the HTTP server and runner, daemon lifecycle | `src/brain`, `server`, `daemon`, `client`, `agent`, `review`, `registry` (migration only), `graph` | Brain capsule [`src/brain/AGENTS.md`](src/brain/AGENTS.md), interface [`src/brain/INTERFACE.md`](src/brain/INTERFACE.md); server facade [`src/server/AGENTS.md`](src/server/AGENTS.md); nested persistence facades [`src/brain/journal/AGENTS.md`](src/brain/journal/AGENTS.md), [`src/brain/schedule/AGENTS.md`](src/brain/schedule/AGENTS.md), [`src/brain/run/AGENTS.md`](src/brain/run/AGENTS.md), [`src/brain/attachment/AGENTS.md`](src/brain/attachment/AGENTS.md), [`src/brain/projection/AGENTS.md`](src/brain/projection/AGENTS.md); Daemon capsule [`src/daemon/AGENTS.md`](src/daemon/AGENTS.md), interface [`src/daemon/INTERFACE.md`](src/daemon/INTERFACE.md); see the [Brain test inventory](tests/BRAIN_TEST_INVENTORY.md) |
| **`frontend`** (5): commands, the interactive REPL, rendering, setup | `src/cli`, `startup.rs`, `samples.rs` | CLI facade [`src/cli/AGENTS.md`](src/cli/AGENTS.md); capsule [`src/cli/repl_event/AGENTS.md`](src/cli/repl_event/AGENTS.md) for the event loop; capsule [`src/cli/messages/AGENTS.md`](src/cli/messages/AGENTS.md) for typed messages and WorkUnit domain snapshots; capsule [`src/cli/components/AGENTS.md`](src/cli/components/AGENTS.md) for component-owned ViewModels and subwidgets ([design](docs/TUI_DESIGN.md)); capsule [`src/cli/tui/AGENTS.md`](src/cli/tui/AGENTS.md), interface [`src/cli/tui/INTERFACE.md`](src/cli/tui/INTERFACE.md); [TUI renderer](src/cli/tui/ARCHITECTURE.md), [atomic history](src/cli/repl_event/ATOMIC_HISTORY.md) |
...
loop is gone: production `crates/finch-runtime` cannot import the root `brain` module (there is no
runtime scheduler module and no `RunId` import). `src/brain/store.rs` still imports `runtime`,
