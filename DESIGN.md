...
| **`source-index`** (0): exact-byte source identity, bounded spans and provenance, deterministic structural outlines, and stale-result validation | `src/source_index` | [README](src/source_index/README.md), [agent contract](src/source_index/AGENTS.md), [facade](src/source_index/mod.rs) |
