...
|-----------------------------------|------|---------------------|
| **`config`** (0): configuration, instruction loading, licensing, metrics | `src/config`, `context`, `license`, `metrics`, `monitoring`, `errors.rs`; `data/` personas | Config [README](src/config/README.md), [capsule](src/config/AGENTS.md), [facade](src/config/mod.rs); context [README](src/context/README.md), [capsule](src/context/AGENTS.md), [facade](src/context/mod.rs); [configuration](src/config/CONFIGURATION.md), [context assembly](src/context/ASSEMBLY.md), [licensing](src/license/LICENSING.md) |
...
| **`diff`** (1): bounded, terminal-safe structured file-diff presentation | `crates/finch-diff`; root `src/cli/diff.rs` is a compatibility re-export | [README](crates/finch-diff/README.md), [agent contract](crates/finch-diff/AGENTS.md), [facade](crates/finch-diff/src/lib.rs) |
...
| **`models`** (2): local model loading, routing, training, feedback | `src/models`, `local`, `generators`, `training`, `feedback`, `router`, `logging` | Capsule [`src/models/AGENTS.md`](src/models/AGENTS.md), interface [`src/models/INTERFACE.md`](src/models/INTERFACE.md); local-generation facade [`src/local/AGENTS.md`](src/local/AGENTS.md); generators compatibility [README](src/generators/README.md), [capsule](src/generators/AGENTS.md), [facade](src/generators/mod.rs); [Local model loader](src/models/unified_loader.rs), [ONNX loader](src/models/ONNX.md), [bootstrap loading](src/models/BOOTSTRAP.md), [deferred LoRA path](src/models/LORA.md), [router](src/router/ROUTING.md), [automatic-training status](docs/AUTOMATIC_TRAINING.md) |
...
| **`frontend`** (5): commands, the interactive REPL, rendering, setup | `src/cli`, `startup.rs`, `samples.rs` | CLI [README](src/cli/README.md), [agent contract](src/cli/AGENTS.md), [facade](src/cli/mod.rs); capsule [`src/cli/repl_event/AGENTS.md`](src/cli/repl_event/AGENTS.md) for the event loop; messages [README](src/cli/messages/README.md), [agent contract](src/cli/messages/AGENTS.md), and [facade](src/cli/messages/mod.rs) for client-local typed messages and WorkUnit snapshots; application presentation [README](crates/finch-ui-model/README.md), [capsule](crates/finch-ui-model/AGENTS.md), [facade](crates/finch-ui-model/src/lib.rs) for component-owned ViewModels and pure projection ([design](docs/TUI_DESIGN.md)); project-mention composition adapter [`src/cli/mention_session.rs`](src/cli/mention_session.rs); TUI [README](src/cli/tui/README.md), [agent contract](src/cli/tui/AGENTS.md), and [facade](src/cli/tui/mod.rs); [TUI renderer](src/cli/tui/ARCHITECTURE.md), [atomic history](src/cli/repl_event/ATOMIC_HISTORY.md) |
