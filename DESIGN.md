...
| **`transport`** (3): Cap'n Proto IPC, node identity, service discovery | `src/ipc`, `node`, `network`, `service`, `node_name.rs`; `schema/` | IPC capsule [`src/ipc/AGENTS.md`](src/ipc/AGENTS.md), interface [`src/ipc/INTERFACE.md`](src/ipc/INTERFACE.md); nested codec [`src/ipc/codec/AGENTS.md`](src/ipc/codec/AGENTS.md), interface [`src/ipc/codec/INTERFACE.md`](src/ipc/codec/INTERFACE.md); Node capsule [`src/node/AGENTS.md`](src/node/AGENTS.md), interface [`src/node/INTERFACE.md`](src/node/INTERFACE.md); wire schema in [`schema/finch_ipc.capnp`](schema/finch_ipc.capnp) |
