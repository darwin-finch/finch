...
| **`source-index`** (0): exact-byte source identity, bounded spans and provenance, body-free structural outlines, Git-defined directory menus, atomic repository cache, and stale-generation validation | `src/source_index` | [README](src/source_index/README.md), [agent contract](src/source_index/AGENTS.md), [facade](src/source_index/mod.rs) |
