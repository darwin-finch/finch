...
| **`brain`** (4): durable named Brains, the HTTP server and runner, daemon lifecycle | `crates/finch-brain`, root `server`, `daemon`, `client`, `agent`, `review`, `registry` (migration only), `graph` | Brain capsule [`crates/finch-brain/AGENTS.md`](crates/finch-brain/AGENTS.md), interface [`crates/finch-brain/INTERFACE.md`](crates/finch-brain/INTERFACE.md); server facade [`src/server/AGENTS.md`](src/server/AGENTS.md); nested persistence facades [`attachment`](crates/finch-brain/src/attachment/AGENTS.md), [`journal`](crates/finch-brain/src/journal/AGENTS.md), [`projection`](crates/finch-brain/src/projection/AGENTS.md), [`run`](crates/finch-brain/src/run/AGENTS.md), and [`schedule`](crates/finch-brain/src/schedule/AGENTS.md); Daemon capsule [`src/daemon/AGENTS.md`](src/daemon/AGENTS.md), interface [`src/daemon/INTERFACE.md`](src/daemon/INTERFACE.md); see the [Brain test inventory](tests/BRAIN_TEST_INVENTORY.md) |
