...
| **`models`** (2): local model loading, routing, training, feedback | `src/models`, `local`, `generators`, `training`, `feedback`, `router`, `logging` | Capsule [`src/models/AGENTS.md`](src/models/AGENTS.md), interface [`src/models/INTERFACE.md`](src/models/INTERFACE.md); local generation [README](src/local/README.md), [agent contract](src/local/AGENTS.md), [facade](src/local/mod.rs); generators compatibility [README](src/generators/README.md), [capsule](src/generators/AGENTS.md), [facade](src/generators/mod.rs); [Local model loader](src/models/unified_loader.rs), [ONNX loader](src/models/ONNX.md), [bootstrap loading](src/models/BOOTSTRAP.md), [deferred LoRA path](src/models/LORA.md), [router](src/router/ROUTING.md), [automatic-training status](docs/AUTOMATIC_TRAINING.md) |
