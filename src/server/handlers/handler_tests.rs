...
async fn websocket_teardown_is_bounded_and_connection_scoped() {
    ...
    let mut forwarding = Box::pin(crate::server::ipc::forward_test_runner_request(
        runner,
        server.clone(),
    ...
    let mut pending_approval =
        Box::pin(crate::server::ipc::request_test_turn_approval_with_client(
            stale_control.clone(),
    ...
    let stale_error = tokio::time::timeout(
        ...
        crate::server::ipc::request_test_turn_approval_with_client(
            stale_control,
            crate::server::RunnerTurnEvent::ApprovalRequested {
...
async fn ordinary_websocket_disconnect_cancels_exact_runner_and_preserves_completed_run() {
    ...
    let mut approval = Box::pin(crate::server::ipc::request_test_turn_approval_with_client(
        control,
        crate::server::RunnerTurnEvent::ApprovalRequested {
    ...
    crate::server::ipc::forward_test_runner_request(
        runner,
        server.clone(),
...
async fn restarted_queued_prompts_dispatch_task_state_at_their_exact_request_sequence() {
    ...
    let queued_runner = async move {
        ...
        while index < 2 {
            ...
            let approval = crate::server::ipc::request_test_turn_approval(
