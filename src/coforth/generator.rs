...
pub const CATEGORIES: &[(&str, &[&str])] = &[
    ...
    ("personality-and-character", &[
        "kind", "cruel", "generous", "selfish", "humble", "arrogant", "patient", "impatient",
        "honest", "dishonest", "loyal", "disloyal", "brave", "cowardly", "wise", "foolish",
        "creative", "rigid", "flexible", "stubborn", "open", "closed", "warm", "cold",
        "playful", "serious", "curious", "incurious", "enthusiastic", "apathetic",
        "confident", "insecure", "assertive", "passive", "reliable", "unreliable",
        "empathetic", "indifferent", "generous", "stingy", "forgiving", "vengeful",
        "decisive", "indecisive", "optimistic", "pessimistic", "cheerful", "gloomy",
        "focused", "distracted", "disciplined", "undisciplined", "ambitious", "content",
        "authentic", "fake", "principled", "unprincipled", "gracious", "rude",
        "tactful", "blunt", "sensitive", "tough", "resilient", "fragile",
    ]),

    ("sports-and-games", &[
        "run", "jump", "throw", "catch", "kick", "hit", "swim", "climb", "race", "win",
        "lose", "draw", "score", "goal", "point", "match", "game", "tournament",
        "team", "player", "coach", "referee", "stadium", "field", "court", "track",
        "ball", "net", "goal", "basket", "bat", "glove", "helmet", "jersey",
        "practice", "train", "compete", "challenge", "defeat", "victory", "tie",
        "season", "league", "championship", "record", "medal", "trophy", "prize",
        "chess", "card", "dice", "board", "strategy", "move", "piece", "level",
        "puzzle", "solve", "play", "cheat", "fair", "foul", "penalty", "reward",
    ]),

    ("tools-and-making", &[
        "hammer", "nail", "screw", "bolt", "wrench", "drill", "saw", "chisel",
        "blade", "handle", "grip", "lever", "pulley", "gear", "wheel", "axle",
        "build", "construct", "assemble", "disassemble", "repair", "fix", "break",
        "measure", "cut", "carve", "shape", "mould", "cast", "forge", "weld",
        "paint", "sand", "polish", "finish", "coat", "seal", "fasten", "loosen",
        "tool", "machine", "engine", "motor", "battery", "wire", "cable", "pipe",
        "material", "wood", "metal", "stone", "glass", "plastic", "rubber", "fabric",
        "sharp", "blunt", "heavy", "light", "strong", "weak", "flexible", "rigid",
    ]),

    ("law-and-justice", &[
        "law", "rule", "right", "duty", "obligation", "permission", "prohibition",
        "crime", "punishment", "penalty", "fine", "prison", "freedom", "justice",
        "fairness", "equality", "inequality", "bias", "discrimination", "privilege",
        "judge", "court", "trial", "evidence", "proof", "verdict", "sentence",
        "guilty", "innocent", "accused", "victim", "witness", "lawyer", "prosecutor",
        "contract", "agreement", "breach", "dispute", "settlement", "appeal",
        "constitution", "amendment", "statute", "regulation", "policy", "enforcement",
        "authority", "power", "jurisdiction", "sovereignty", "rights", "civil",
        "criminal", "moral", "legal", "illegal", "valid", "invalid", "binding",
    ]),

    ("medicine-and-body", &[
        "health", "illness", "disease", "symptom", "diagnosis", "treatment", "cure",
        "medicine", "drug", "dose", "side-effect", "allergy", "immune", "infection",
        "virus", "bacteria", "inflammation", "fever", "pain", "ache", "wound",
        "heal", "recover", "relapse", "chronic", "acute", "contagious", "epidemic",
        "surgery", "operation", "transplant", "therapy", "rehabilitation",
        "doctor", "nurse", "patient", "hospital", "clinic", "emergency",
        "heart", "lung", "liver", "kidney", "brain", "spine", "bone", "muscle",
        "blood", "cell", "tissue", "organ", "nerve", "hormone", "metabolism",
        "prevention", "vaccine", "antibody", "cancer", "diabetes", "mental-health",
        "depression", "anxiety", "trauma", "resilience", "wellbeing", "longevity",
    ]),

    ("architecture-and-place", &[
        "building", "structure", "foundation", "floor", "ceiling", "wall", "column",
        "arch", "dome", "tower", "bridge", "tunnel", "road", "street", "path",
        "city", "town", "village", "suburb", "district", "neighbourhood", "block",
        "house", "apartment", "office", "shop", "market", "factory", "warehouse",
        "library", "school", "hospital", "church", "temple", "monument", "museum",
        "park", "garden", "square", "plaza", "courtyard", "corridor", "staircase",
        "entrance", "exit", "gate", "fence", "border", "boundary", "territory",
        "space", "room", "area", "zone", "region", "landscape", "urban", "rural",
    ]),

    ("technology-and-computing", &[
        "computer", "processor", "memory", "storage", "network", "internet", "server",
        "software", "hardware", "program", "code", "bug", "debug", "test", "deploy",
        "update", "version", "backup", "restore", "encrypt", "secure", "hack",
        "interface", "user", "input", "output", "display", "screen", "keyboard",
        "mouse", "touch", "click", "swipe", "scroll", "zoom", "search", "browse",
        "download", "upload", "share", "stream", "cloud", "platform", "device",
        "mobile", "wireless", "bandwidth", "latency", "protocol", "standard",
        "automation", "robot", "artificial", "algorithm", "data", "model", "predict",
        "learn", "train", "optimize", "scale", "performance", "reliability", "security",
    ]),

    ("weather-and-seasons", &[
        "sun", "rain", "snow", "wind", "storm", "thunder", "lightning", "fog",
        "cloud", "sky", "temperature", "heat", "cold", "warm", "frost", "ice",
        "spring", "summer", "autumn", "winter", "season", "climate", "weather",
        "flood", "drought", "hurricane", "tornado", "earthquake", "eruption",
        "sunrise", "sunset", "dawn", "dusk", "noon", "midnight", "twilight",
        "humid", "dry", "wet", "clear", "cloudy", "stormy", "calm", "breeze",
        "shower", "downpour", "drizzle", "blizzard", "hailstorm", "rainbow",
    ]),

    ("plants-and-nature", &[
        "tree", "flower", "grass", "leaf", "root", "branch", "trunk", "bark",
        "seed", "fruit", "vegetable", "herb", "mushroom", "moss", "fern", "weed",
        "rose", "oak", "pine", "willow", "bamboo", "cactus", "vine", "shrub",
        "garden", "forest", "jungle", "meadow", "desert", "wetland", "marsh",
        "soil", "earth", "rock", "sand", "clay", "mineral", "crystal", "fossil",
        "photosynthesis", "pollination", "germination", "growth", "decay", "compost",
        "bloom", "wither", "prune", "harvest", "plant", "sow", "water", "fertilise",
    ]),

    ("animals-and-living", &[
        "animal", "mammal", "bird", "fish", "insect", "reptile", "amphibian",
        "dog", "cat", "horse", "cow", "sheep", "pig", "chicken", "rabbit",
        "lion", "tiger", "elephant", "whale", "dolphin", "wolf", "bear", "fox",
        "eagle", "owl", "penguin", "butterfly", "bee", "ant", "spider", "snake",
        "wild", "tame", "predator", "prey", "hunt", "migrate", "hibernate", "nest",
        "flock", "herd", "pack", "swarm", "hatch", "breed", "feed", "shelter",
        "instinct", "habitat", "ecosystem", "food-chain", "extinction", "conservation",
        "domestic", "exotic", "endangered", "invasive", "symbiotic", "parasitic",
    ]),

    ("thought-and-cognition", &[
        "think", "reason", "infer", "deduce", "conclude", "assume", "presume",
        "question", "wonder", "examine", "analyse", "evaluate", "compare", "contrast",
        "reflect", "contemplate", "meditate", "concentrate", "focus", "distract",
        "remember", "forget", "recall", "recognise", "identify", "categorise",
        "understand", "misunderstand", "confuse", "clarify", "interpret", "explain",
        "judge", "criticise", "justify", "rationalise", "argue", "convince", "doubt",
        "believe", "know", "sense", "perceive", "notice", "overlook", "attend",
        "plan", "decide", "choose", "hesitate", "commit", "change", "adapt", "learn",
        "concept", "idea", "thought", "opinion", "belief", "assumption", "conclusion",
    ]),

    ("change-and-transformation", &[
        "change", "transform", "convert", "shift", "evolve", "develop", "progress",
        "grow", "shrink", "expand", "contract", "increase", "decrease", "multiply",
        "divide", "merge", "split", "combine", "separate", "unite", "disperse",
        "rise", "fall", "ascend", "descend", "accelerate", "decelerate", "stabilise",
        "improve", "deteriorate", "restore", "destroy", "create", "end", "begin",
        "replace", "renew", "refresh", "regenerate", "recover", "collapse", "rebuild",
        "adapt", "adjust", "modify", "revise", "correct", "fix", "break", "mend",
        "transition", "revolution", "evolution", "cycle", "process", "phase", "stage",
    ]),

    ("movement-and-gesture", &[
        "walk", "run", "jump", "crawl", "climb", "slide", "roll", "spin",
        "push", "pull", "lift", "carry", "throw", "catch", "drop", "pick",
        "reach", "stretch", "bend", "twist", "turn", "shake", "nod", "wave",
        "point", "touch", "grasp", "hold", "release", "embrace", "push", "shove",
        "dance", "march", "stride", "shuffle", "stumble", "fall", "rise", "leap",
        "creep", "sneak", "rush", "hurry", "pause", "stop", "continue", "retreat",
        "advance", "approach", "avoid", "follow", "lead", "guide", "wander", "stray",
        "gesture", "signal", "mime", "pose", "balance", "coordinate", "move", "still",
    ]),

    ("communication-acts", &[
        "say", "tell", "ask", "answer", "explain", "describe", "define", "clarify",
        "agree", "disagree", "argue", "debate", "discuss", "negotiate", "persuade",
        "promise", "threaten", "warn", "advise", "suggest", "recommend", "instruct",
        "order", "request", "beg", "demand", "refuse", "accept", "reject", "confirm",
        "deny", "admit", "confess", "apologise", "forgive", "thank", "greet", "farewell",
        "announce", "report", "inform", "notify", "remind", "mention", "introduce",
        "praise", "criticise", "complain", "protest", "challenge", "support", "contradict",
        "translate", "interpret", "paraphrase", "quote", "summarise", "elaborate",
    ]),

    ("finance-and-value", &[
        "money", "price", "cost", "value", "worth", "wealth", "poverty", "income",
        "spend", "save", "invest", "borrow", "lend", "pay", "owe", "debt", "credit",
        "profit", "loss", "revenue", "expense", "budget", "tax", "subsidy", "grant",
        "market", "trade", "buy", "sell", "exchange", "auction", "bid", "offer",
        "inflation", "deflation", "recession", "growth", "economy", "finance",
        "bank", "interest", "dividend", "share", "stock", "bond", "asset", "liability",
        "rich", "poor", "afford", "cheap", "expensive", "discount", "bargain", "luxury",
        "resource", "capital", "labour", "production", "consumption", "distribution",
    ]),

    ("food-preparation", &[
        "cook", "bake", "fry", "boil", "steam", "grill", "roast", "simmer",
        "chop", "slice", "dice", "mince", "peel", "grate", "mix", "blend",
        "season", "marinate", "garnish", "serve", "taste", "smell", "texture",
        "recipe", "ingredient", "portion", "meal", "course", "dish", "cuisine",
        "sweet", "sour", "salty", "bitter", "spicy", "mild", "rich", "fresh",
        "raw", "cooked", "ripe", "rotten", "frozen", "dried", "canned", "organic",
        "breakfast", "lunch", "dinner", "snack", "feast", "fast", "diet", "nutrition",
        "hungry", "full", "appetite", "craving", "satisfy", "nourish", "digest",
    ]),

    ("common-adjectives-expanded", &[
        "able", "actual", "basic", "certain", "clear", "common", "complete", "current",
        "different", "difficult", "direct", "early", "easy", "effective", "entire",
        "final", "free", "full", "good", "great", "hard", "high", "human", "important",
        "large", "last", "late", "likely", "little", "long", "low", "main", "major",
        "many", "most", "much", "necessary", "new", "next", "normal", "obvious",
        "only", "open", "original", "particular", "past", "personal", "physical",
        "political", "possible", "present", "private", "public", "real", "recent",
        "right", "same", "several", "significant", "simple", "single", "small",
        "social", "special", "strong", "sure", "total", "true", "usual", "various",
    ]),

    ("common-verbs-core", &[
        "be", "have", "do", "make", "go", "get", "take", "know", "think", "see",
        "come", "want", "look", "use", "find", "give", "tell", "feel", "become",
        "leave", "put", "mean", "keep", "let", "begin", "show", "hear", "play",
        "run", "move", "live", "believe", "hold", "bring", "happen", "write",
        "provide", "stand", "lose", "pay", "meet", "include", "continue", "set",
    ...
    ("consciousness-and-self", &[
        "self", "identity", "ego", "persona", "character", "soul", "mind", "body",
        "consciousness", "awareness", "attention", "intention", "will", "choice",
        "agency", "autonomy", "freedom", "constraint", "habit", "instinct", "impulse",
        "emotion", "feeling", "thought", "perception", "sensation", "imagination",
        "memory", "dream", "desire", "fear", "hope", "regret", "nostalgia",
        "present", "moment", "flow", "stillness", "presence", "absence",
        "growth", "stagnation", "potential", "limitation", "possibility", "reality",
        "authentic", "genuine", "mask", "role", "performance", "vulnerability",
        "worth", "dignity", "shame", "pride", "acceptance", "resistance", "surrender",
    ]),

    ("social-phenomena", &[
        "culture", "society", "norm", "taboo", "ritual", "ceremony", "celebration",
        "festival", "holiday", "custom", "tradition", "fashion", "trend", "style",
        "symbol", "meaning", "sign", "language", "dialect", "accent", "story",
        "myth", "legend", "history", "memory", "archive", "monument", "heritage",
        "class", "status", "prestige", "reputation", "honour", "disgrace",
        "conformity", "rebellion", "revolution", "reform", "progress", "regression",
        "inclusion", "exclusion", "belonging", "outsider", "insider", "community",
        "solidarity", "conflict", "cooperation", "competition", "collaboration",
        "power", "resistance", "oppression", "liberation", "equality", "hierarchy",
    ]),

    ("art-forms", &[
        "painting", "drawing", "sculpture", "photography", "film", "theatre",
        "dance", "music", "poetry", "fiction", "essay", "architecture", "design",
        "craft", "performance", "installation", "digital", "print", "collage",
        "colour", "line", "form", "composition", "perspective", "texture", "contrast",
        "harmony", "rhythm", "melody", "chord", "tempo", "dynamics", "silence",
        "metaphor", "symbol", "image", "narrative", "character", "plot", "theme",
        "genre", "style", "technique", "medium", "material", "tool", "process",
        "beauty", "sublime", "grotesque", "absurd", "tragic", "comic", "ironic",
        "original", "imitation", "interpretation", "criticism", "appreciation",
    ]),

    ("size-and-degree", &[
        "big", "small", "large", "tiny", "huge", "vast", "immense", "microscopic",
        "tall", "short", "wide", "narrow", "deep", "shallow", "thick", "thin",
        "heavy", "light", "dense", "sparse", "full", "empty", "half", "quarter",
        "more", "less", "most", "least", "enough", "too", "very", "quite", "rather",
        "extremely", "slightly", "barely", "nearly", "almost", "completely",
        "maximum", "minimum", "average", "median", "extreme", "moderate",
        "double", "triple", "twice", "half", "fraction", "multiple", "single",
        "infinite", "finite", "zero", "whole", "partial", "total", "excess", "deficit",
    ]),

    ("texture-and-material", &[
        "smooth", "rough", "soft", "hard", "silky", "coarse", "fine", "grainy",
        "sharp", "blunt", "sticky", "slippery", "elastic", "rigid", "brittle",
        "porous", "solid", "liquid", "gas", "plasma", "dense", "light", "heavy",
        "transparent", "opaque", "reflective", "matte", "glossy", "dull",
        "warm", "cool", "dry", "wet", "viscous", "fluid", "crystalline", "amorphous",
        "metal", "wood", "stone", "glass", "plastic", "rubber", "ceramic", "cloth",
        "leather", "paper", "concrete", "brick", "sand", "mud", "ice", "wax",
        "fragile", "durable", "flexible", "stiff", "hollow", "filled", "layered",
    ]),

    ("academic-subjects", &[
        "mathematics", "physics", "chemistry", "biology", "history", "geography",
        "literature", "philosophy", "psychology", "sociology", "economics",
        "anthropology", "linguistics", "archaeology", "theology", "medicine",
        "law", "engineering", "architecture", "art", "music", "drama", "film",
        "politics", "education", "pedagogy", "research", "theory", "practice",
        "experiment", "observation", "hypothesis", "evidence", "conclusion",
        "method", "framework", "paradigm", "critique", "analysis", "synthesis",
        "primary", "secondary", "source", "citation", "peer-review", "publication",
        "conference", "lecture", "seminar", "tutorial", "assignment", "thesis",
    ]),

    ("character-in-story", &[
        "hero", "villain", "mentor", "guide", "shadow", "trickster", "lover",
        "warrior", "sage", "innocent", "explorer", "creator", "ruler", "caregiver",
        "rebel", "jester", "orphan", "seeker", "magician", "everyman",
        "protagonist", "antagonist", "narrator", "witness", "victim", "saviour",
        "motive", "flaw", "strength", "weakness", "desire", "fear", "wound",
        "arc", "transformation", "revelation", "decision", "sacrifice", "redemption",
        "betrayal", "loyalty", "love", "hate", "ambition", "regret", "acceptance",
        "voice", "perspective", "point-of-view", "interior", "exterior", "mask",
    ]),

    ("philosophical-concepts", &[
        "being", "existence", "essence", "substance", "form", "matter", "cause",
        "effect", "necessity", "contingency", "possibility", "actuality", "potential",
        "universal", "particular", "abstract", "concrete", "ideal", "real",
        "subject", "object", "relation", "property", "quality", "quantity",
        "space", "time", "motion", "change", "permanence", "flux", "identity",
        "difference", "same", "other", "one", "many", "whole", "part",
        "good", "evil", "right", "wrong", "just", "unjust", "beautiful", "ugly",
        "true", "false", "certain", "uncertain", "known", "unknown",
        "mind", "body", "world", "god", "nature", "reason", "will", "fate",
        "free", "determined", "conscious", "unconscious", "self", "other",
    ]),

    ("relationships-between-things", &[
        "cause", "effect", "before", "after", "because", "therefore", "although",
        "however", "despite", "unless", "until", "since", "while", "when",
        "if", "then", "else", "both", "either", "neither", "not", "and", "or",
        "above", "below", "beside", "between", "among", "within", "outside",
        "toward", "away", "through", "across", "along", "around", "against",
        "same", "different", "like", "unlike", "more", "less", "as", "than",
        "with", "without", "by", "for", "from", "to", "of", "about",
        "whole", "part", "container", "contained", "source", "destination",
        "agent", "patient", "instrument", "means", "end", "purpose", "result",
    ]),

    ("positive-states", &[
        "happy", "joyful", "content", "peaceful", "calm", "serene", "grateful",
        "hopeful", "optimistic", "excited", "enthusiastic", "inspired", "motivated",
        "satisfied", "fulfilled", "proud", "confident", "secure", "safe", "loved",
        "accepted", "valued", "respected", "seen", "heard", "understood",
        "alive", "present", "engaged", "connected", "whole", "complete",
        "playful", "creative", "curious", "open", "free", "light", "clear",
        "strong", "capable", "resilient", "brave", "courageous", "determined",
        "generous", "compassionate", "kind", "loving", "forgiving", "gentle",
    ]),

    ("negative-states", &[
        "sad", "depressed", "miserable", "hopeless", "despairing", "defeated",
        "angry", "furious", "resentful", "bitter", "envious", "jealous", "hateful",
        "afraid", "terrified", "anxious", "worried", "stressed", "overwhelmed",
        "ashamed", "guilty", "embarrassed", "humiliated", "worthless", "empty",
        "lonely", "isolated", "abandoned", "rejected", "betrayed", "hurt",
        "confused", "lost", "uncertain", "helpless", "powerless", "stuck",
        "bored", "restless", "numb", "disconnected", "hollow", "flat",
        "tired", "exhausted", "drained", "burned-out", "weary", "heavy",
        "trapped", "suffocated", "invisible", "unheard", "misunderstood",
    ]),

    ("time-expressions", &[
        "now", "then", "soon", "later", "eventually", "immediately", "suddenly",
        "gradually", "slowly", "quickly", "briefly", "permanently", "temporarily",
        "recently", "formerly", "previously", "subsequently", "simultaneously",
        "often", "sometimes", "rarely", "never", "always", "usually", "occasionally",
        "early", "late", "on-time", "delayed", "scheduled", "spontaneous",
        "past", "present", "future", "ancient", "modern", "contemporary",
        "begin", "end", "continue", "pause", "resume", "repeat", "stop",
        "second", "minute", "hour", "day", "week", "month", "year", "decade",
        "century", "era", "age", "epoch", "moment", "instant", "duration",
    ]),

    ("ethics-and-values", &[
        "good", "bad", "right", "wrong", "just", "unjust", "fair", "unfair",
        "honest", "dishonest", "kind", "cruel", "generous", "selfish", "brave",
        "cowardly", "loyal", "disloyal", "humble", "arrogant", "respectful",
        "compassionate", "empathetic", "indifferent", "responsible", "irresponsible",
        "authentic", "hypocritical", "transparent", "deceptive", "trustworthy",
        "harm", "benefit", "duty", "right", "virtue", "vice", "character",
        "consent", "autonomy", "dignity", "equality", "justice", "care",
        "honesty", "integrity", "courage", "temperance", "wisdom", "justice",
        "love", "friendship", "gratitude", "forgiveness", "mercy", "solidarity",
        "reciprocity", "fairness", "harm-reduction", "wellbeing", "flourishing",
    ]),

    ("narrative-structure", &[
        "beginning", "middle", "end", "setup", "conflict", "climax", "resolution",
        "exposition", "rising-action", "falling-action", "denouement",
        "chapter", "scene", "act", "episode", "sequence", "montage",
        "flashback", "foreshadowing", "suspense", "tension", "release",
        "twist", "reveal", "surprise", "expectation", "subversion",
        "theme", "motif", "symbol", "metaphor", "allegory", "irony",
        "tone", "mood", "atmosphere", "voice", "style", "register",
        "perspective", "point-of-view", "omniscient", "limited", "unreliable",
        "open", "closed", "circular", "linear", "nonlinear", "frame",
    ]),

    ("science-concepts", &[
        "hypothesis", "theory", "law", "model", "experiment", "observation",
        "measurement", "variable", "control", "replication", "falsification",
        "peer-review", "publication", "evidence", "proof", "disproof",
        "correlation", "causation", "mechanism", "process", "system", "complexity",
        "emergence", "entropy", "equilibrium", "symmetry", "conservation",
        "force", "energy", "mass", "charge", "field", "wave", "particle",
        "space", "time", "matter", "vacuum", "constant", "limit", "approximation",
        "dimension", "scale", "resolution", "precision", "accuracy", "uncertainty",
        "reduction", "emergence", "holism", "reductionism", "determinism",
    ]),
];
