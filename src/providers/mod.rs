...
pub use finch_providers::{
    ...
    fallback_catalog, grok_required_scopes, profile_cache_identity, read_cache, refresh,
    refresh_with_fallback, static_fallback, with_alignment, CapabilityProvenance,
    CapabilitySupport, CatalogAuth, CatalogSource, ChatGptAuthStageError,
