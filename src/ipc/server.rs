...
mod tests {
    ...
    /// A runner whose connection breaks during every callback.
    ...
    async fn broken_runner_connection_declares_itself_unavailable_to_memory_replay() {
        ...
        let error = response_rx
            .await
            .expect("memory forwarding dropped its result channel")
            .expect_err("a broken connection cannot project memory");
        assert!(
            error.starts_with(crate::server::RUNNER_UNAVAILABLE_PREFIX),
            "transport failure must be systemic so replay aborts; error={error:?}"
        );
    }
                        ...
                        crate::cli::repl_event::ReplEvent::NamedBrainMemoryProjectionRequested(
                            crate::cli::repl_event::events::BoundedRunnerRequest {
                                request: crate::server::RunnerMemoryProjectionRequest {
                                    ...
                                    rendered: "cancelled assistant memory".into(),
                        ...
                        crate::cli::repl_event::ReplEvent::NamedBrainMemoryProjectionRequested(
                            crate::cli::repl_event::events::BoundedRunnerRequest {
                                request: crate::server::RunnerMemoryProjectionRequest {
                                    ...
                                    rendered: "successor assistant memory".into(),
